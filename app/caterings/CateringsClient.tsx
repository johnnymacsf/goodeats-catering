...
interface CateringsClientProps{
    reservations: SafeReservation[];
    currentUser?: SafeUser | null;
}

const CateringsClient: React.FC<CateringsClientProps> = ({
    reservations,
    currentUser
}) => {
    ...
    return(
        <Container>
            <Heading title="Caterings" subtitle="Caterings you've have before"/>
...
export default CateringsClient;